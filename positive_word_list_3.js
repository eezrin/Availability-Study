...
{ stimulus: "SONG" , data: { stim_type: "positive" } },
{ stimulus: "DREAM" , data: { stim_type: "positive" } },
{ stimulus: "VICTORY" , data: { stim_type: "positive" } },
{ stimulus: "STAR" , data: { stim_type: "positive" } },
{ stimulus: "WEDDING" , data: { stim_type: "positive" } },
{ stimulus: "HAPPINESS" , data: { stim_type: "positive" } },
{ stimulus: "BEAUTY" , data: { stim_type: "positive" } },
{ stimulus: "WARMTH" , data: { stim_type: "positive" } },
{ stimulus: "REWARD" , data: { stim_type: "positive" } },
{ stimulus: "MONEY" , data: { stim_type: "positive" } },
{ stimulus: "WINNER" , data: { stim_type: "positive" } },
{ stimulus: "PASSION" , data: { stim_type: "positive" } },
{ stimulus: "ENCOUNTER" , data: { stim_type: "neutral" } },
{ stimulus: "SIGN" , data: { stim_type: "neutral" } },
{ stimulus: "STORAGE" , data: { stim_type: "neutral" } },
{ stimulus: "LOOP" , data: { stim_type: "neutral" } },
{ stimulus: "SQUARE" , data: { stim_type: "neutral" } },
{ stimulus: "PIECE" , data: { stim_type: "neutral" } },
{ stimulus: "CONCLUSION" , data: { stim_type: "neutral" } },
{ stimulus: "PIPE" , data: { stim_type: "neutral" } },
{ stimulus: "TRAINING" , data: { stim_type: "neutral" } },
{ stimulus: "TIMER" , data: { stim_type: "neutral" } },
{ stimulus: "NETWORK" , data: { stim_type: "neutral" } },
{ stimulus: "ENGINE" , data: { stim_type: "neutral" } },
{ stimulus: "CLOCK" , data: { stim_type: "neutral" } },
];
